...
public class KeycloakUserProfileService implements UserProfileService {
    ...
    public ProfileResponseDTO updateProfile(String userId, UpdateProfileDTO dto) {
        final var body = Map.of("firstName", dto.firstName(),
    ...
    public void updatePassword(String userId, UpdatePasswordDTO dto) {
        ...
        final var credentials = Map.of("type", "password",
    ...
    public ProfileResponseDTO updatePhoto(String userId, String photoUrl) {
        ...
        final var attributes = new java.util.HashMap<String, Object>();
        attributes.put("picture", List.of(photoUrl));

        final var body = Map.of("email", user.get("email"),
    ...
    private String getServiceAccountToken() {
        ...
        if (response == null) {
            throw new RuntimeException("Failed to obtain service account token");
        }
    ...
    private String getTokenUri() {
        return keycloakProperties.getServerUrl() + "/realms/" + keycloakProperties.getRealm() + "/protocol/openid" +
                "-connect/token";
    }
    ...
    private ProfileResponseDTO toProfileResponse(Map<String, Object> user) {
        ...
        return new ProfileResponseDTO((String) user.get("id"),
